...
(Recall=0.591, F1=0.718). Source code: (\url{https://github.com/AykhanJ/DeepLearningProject})
\end{abstract}
...
\vspace{10mm}
\subsection{Benchmark Datasets for IDS}
...
\vspace{5mm}
\subsection{Imbalance and Evaluation Metrics}
...
\subsection{Deep Model: Multilayer Perceptron}
...
\subsection{Imbalance Handling Extension}
...
\subsection{Hyperparameter Selection and Training Details}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{../results/mlp_training_curve.pdf}
\caption{MLP training loss and validation F1 across epochs (early stopping selects the best validation F1).}
\label{fig:curve}
\end{figure}


\subsection{Discussion: Validation vs.\ Test Gap}
